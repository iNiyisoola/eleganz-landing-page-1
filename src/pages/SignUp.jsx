export const SignUp = () => {
  ...
  return(
    <div className="container mx-auto ">
      <form action="">
          <div class="flex my-auto  flex-col justify-center px-6 lg:px-8 py-8 md:py-12 text-sm sm:text-md text-slate-600">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
              <h2 class="mt-5 text-center text-2xl sm:text-4xl md:text-5xl text-slate-800 font-semibold sm:font-bold tracking-tight text-pretty lg:text-balance">Sign Up</h2>
            </div>
